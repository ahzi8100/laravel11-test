        ...
        <div class="flex justify-between w-full">
            ...
            <div class="flex space-x-3 items-center">
                <form method="GET" class="w-lg">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" name="title" id="default-search"
                            ...
                            placeholder="Search blog..." value="{{ $title }}" />
                        <button type="submit"
                ...
                <a href="{{ route('blogs.trash') }}"
                    class="text-white bg-yellow-400 hover:bg-yellow-600 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-yellow-600 dark:hover:bg-yellow-700 focus:outline-none dark:focus:ring-yellow-800">
                    Restore
                </a>
        ...
        <div class="overflow-x-auto rounded-lg shadow mb-5">
            <table class="min-w-full text-sm text-left text-gray-700">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @if ($blogs->count() == 0)
                        <tr>
                            <td colspan="3" class="text-center text-2xl py-6">No Data Found with
